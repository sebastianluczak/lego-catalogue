...
@section('content')
    <div class="row justify-content-center" style="background: url('https://www.pngkey.com/png/full/225-2259863_crazy-pinkie-pie-png-clip-freeuse-crazy-pinkie.png'); background-repeat: no-repeat;
  background-size: 35%;">
        <div class="col-12 col-md-8 col-lg-4">
            <h3 class="text-center mb-4"><b>Brodaty.dev </b>LEGO Sets</h3>
            <div class="card" >
                <div class="card-body">
